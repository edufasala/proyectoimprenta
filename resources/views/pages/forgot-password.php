...
<head>
  ...
  <title>Sistema de Imprenta Anton</title>
</head>
      ...
      <div class="panel left-panel">
        <div class="content">
          ...
          <p>
            ...
            <a  type="button" class="btn btn-primary bg-gradient-primary btn-block" href="index.php"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Atras </a>
          </p>
        </div>
